    ...
    <>
      <div className='top-0 fixed w-full h-[10dvh] bg-black text-white flex flex-row items-center justify-around uppercase'>
        ...
        <p className='min-w-[135px] text-3xl'>
          Where is...{' '}
          <span className='text-red-800 italic font-bold'>Everyone?</span>
        </p>
      ...
      <div className='m-16 max-w-full flex flex-col items-center justify-center'>
        <div className='min-w-[70%]'>
          <div className='min-h-[50dvh] text-white text-xl flex flex-col items-center justify-around'>
            <p>Photo Tagging App Project (The Odin Project - Where is Waldo)</p>
            <p>
              Game image by{' '}
